...
<head>
    ...
    <header>
        <div class="search-box">
            <form name="searchSeries" action="/green-netflix/views/serie/search.php" method="post">
        ...
        <div id="user_text" class="MyText">
            <div id="user_login_text" class="MyText">
                ...
                <span id="user_login_link" style="display:none;cursor:pointer;" onclick="openOverlay();">
                    <button type="submit" style="background-color: #92d051;">Login</button>
                </span>
                <span id="user_logout_link" style="display:none;cursor:pointer;" onclick="logout();">
                    <button type="submit" style="background-color: #ef312f;">Logout</button>
                </span>
            </div>
        </div>
